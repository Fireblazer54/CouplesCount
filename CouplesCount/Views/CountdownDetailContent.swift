...
struct CountdownDetailContent: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                hero
                    .padding(.horizontal, namespace == nil ? 16 : 0)
                info
                    .padding(.horizontal)
                sharedSection
                    .padding(.horizontal)
    ...
    private var hero: some View {
        let width = namespace == nil ? UIScreen.main.bounds.width - 32 : UIScreen.main.bounds.width
